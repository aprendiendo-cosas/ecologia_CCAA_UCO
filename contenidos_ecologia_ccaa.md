...
***
+ **Práctica: Búsqueda de bibliografía científica.** <span style="display: inline-block; font-size: 12px; color: white; background-color: #4caf50; border-radius: 5px; padding: 5px; font-weight: bold;"> Prácticas</span>
...
***
+ **Aspectos generales sobre poblaciones ecológicas.** <span style="display: inline-block; font-size: 12px; color: white; background-color: #029BF9; border-radius: 5px; padding: 5px; font-weight: bold;">Teoría</span>
...
+ **Práctica: Manejo de pinares de repoblación. Un ejemplo de la importancia de la competencia intraespecífica.** <span style="display: inline-block; font-size: 12px; color: white; background-color: #4caf50; border-radius: 5px; padding: 5px; font-weight: bold;"> Prácticas</span>
...
+ **Práctica: Caracterización de la conectividad de los espacios de  la Red Natura 2000 en Andalucía** <span style="display: inline-block; font-size: 12px; color: white; background-color: #4caf50; border-radius: 5px; padding: 5px; font-weight: bold;"> Prácticas</span>
...
+ **Tarea: Reflexión sobre relaciones ecológicas. El caso del lobo en Andalucía.**  <span style="display: inline-block; font-size: 12px; color: white; background-color: #8D26F5; border-radius: 5px; padding: 5px; font-weight: bold;"> Tarea</span>
...
+ **Práctica: Cuantificación de la producción primaria de los ecosistemas. ** <span style="display: inline-block; font-size: 12px; color: white; background-color: #4caf50; border-radius: 5px; padding: 5px; font-weight: bold;"> Prácticas</span>(FALTA ARRGLAR LFS)
...
+ **Ecosistemas. Producción secundaria y descomposición. ** <span style="display: inline-block; font-size: 12px; color: white; background-color: #029BF9; border-radius: 5px; padding: 5px; font-weight: bold;">Teoría</span><span style="display: inline-block; font-size: 12px; color: white; background-color: #E68532; border-radius: 5px; padding: 5px; font-weight: bold;"> Aplicación</span>
...
+ **Aproximaciones socioecológicas** <span style="display: inline-block; font-size: 12px; color: white; background-color: #029BF9; border-radius: 5px; padding: 5px; font-weight: bold;">Teoría</span>
  
  + [Descargar material](https://cloud.ecouco.es/d/s/15RQIKXEgBbMZMUil7OHnBHrYjyd1nEF/M-6nLo0G7mDyhqoK6o9qOhZQTgLbDrGz-o7dAf9eHqww)


+ **Práctica: Diseño participativo de escenarios de futuro** <span style="display: inline-block; font-size: 12px; color: white; background-color: #4caf50; border-radius: 5px; padding: 5px; font-weight: bold;"> Prácticas</span>
  
  + [Descargar material](https://cloud.ecouco.es/d/s/15RQHbweSpR9pppcMUShfjG0tDOQOJdn/J8l9bZL677L7rZkRRV03LaVmIQKvlWX7-X7cgfsiHqww)
  
  ***
  
+ **Biosfera. Ciclos biogeoquímicos. La hipótesis Gaia** <span style="display: inline-block; font-size: 12px; color: white; background-color: #029BF9; border-radius: 5px; padding: 5px; font-weight: bold;">Teoría</span><span style="display: inline-block; font-size: 12px; color: white; background-color: #E68532; border-radius: 5px; padding: 5px; font-weight: bold;"> Aplicación</span>
...
![esquema](https://raw.githubusercontent.com/aprendiendo-cosas/ecologia_CCAA_UCO/2021_2022/imagenes/niveles_actividades.png)
...
[Aquí](https://github.com/aprendiendo-cosas/ecologia_CCAA_UCO/archive/refs/tags/2021_2022.zip) puedes descargar un archivo .zip que contiene este guión en formato html y todo el material que incluye. Para descargar el material específico de cada tema debes de navegar hacia cada uno de ellos.
